...
```
# Output:
<img width="499" height="106" alt="image" src="https://github.com/user-attachments/assets/b0afa6d6-6031-4179-97bd-871e968fd0aa" />
...
```
# Output:
<img width="383" height="182" alt="image" src="https://github.com/user-attachments/assets/a53d43e3-5d83-4fff-854a-46a028003a23" />
...
```
# Output:
<img width="594" height="158" alt="image" src="https://github.com/user-attachments/assets/c5615a62-17ab-4152-ba73-f27858469b2e" />
...
```
# Output:
<img width="592" height="134" alt="image" src="https://github.com/user-attachments/assets/b0b27a31-3840-4538-b072-1bf24ed0c05f" />
...
```
# Output:
<img width="496" height="205" alt="image" src="https://github.com/user-attachments/assets/50cd50d7-7a18-4bba-876e-7ee552eb7f75" />
